    ...
    >
      <div style="width: 100%; padding-bottom: 50px; text-align: center;">
        ...
        <div v-if="beforeUp" class="beforeUp">
          ...
          <div v-if="showEmpty" style="width: 100%;margin-top: 30px;">（ 上传格式：仅支持jpg、png格式，分辨率不超过 200 * 200，大小不超过 299M ）</div>

          <el-upload
            ref="upload"
            class="upload-demo"
            action="/v3upload/admin_wx_hello"
...
export default {
  ...
  methods: {
    ...
    getMorningList() {
      this.morningParams.page = this.page - 1

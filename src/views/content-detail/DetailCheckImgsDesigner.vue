      ...
      <div class="content-left">
        <el-form ref="numberValidateForm" :model="numberValidateForm" label-width="100px" style="margin-top: 30px" class="demo-dynamic">
          ...
          <el-form-item
            ...
            prop="major"
          >
            <el-input v-model.number="numberValidateForm.major" placeholder="请输入专业名称" type="age" style="width: 150px" ocomplete="off" />
          </el-form-item>
          <el-form-item
            label="职位"
            prop="major"
          >
            <el-input v-model.number="numberValidateForm.position" placeholder="请输入职位名称" type="age" style="width: 150px" ocomplete="off" />
          </el-form-item>
          <el-form-item
            label="国家"
            prop="country"
          >
            <el-input v-model.number="numberValidateForm.country" placeholder="请输入国家名称" type="age" style="width: 150px" ocomplete="off" />
          </el-form-item>
        </el-form></div>
      <div class="content-right">
        <!--        <el-form-item prop="content" style="margin-bottom: 30px;">-->
        <Tinymce ref="editor" v-model="numberValidateForm.content" style="margin-top: 30px" :width="600" :height="800" />
        <!--        </el-form-item>-->
        <!--        </el-form>-->
      </div>
